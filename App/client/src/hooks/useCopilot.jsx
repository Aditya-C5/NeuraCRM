...
const placeholderMessages = [
  ...
  // { type: "ai", text: "To set up an ad campaign in 'Company' Ads Manager, follow these steps: Log into your 'Company' Ads Manager account, click on 'Create ad', choose your advertising ibjective, set a campaign name, and establish a campaign budget. You can also decide on special ad categories, enable split testing, and optimize the campaign budget if necessary."},
