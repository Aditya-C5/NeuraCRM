...
const demoAIMessages = [
  "'Company' Ads Manager is a platform where you can create and manage ads on 'Company'. You can launch ads and measure performance with 'Company' ads manager.",
  "'Company' Ads Manager account allows you to create targeted ads with Video Creation Kit, generate insight reports about your ads and automate the process of creating, delivering, and optimizing your ads with the Automated Creative Optimization tool.",
  "You can set a daily or lifetime budget that can be changed anytime throughout your campaign. A bid indicates the maximum you will pay for the actions you want users to take after they see your ads. Learn more about 'Company' Ads Bidding & Optimization.",
];
