    ...
    <div className="max-h-screen overflow-y-scroll">
      ...
      <div className="flex flex-col justify-start gap-y-5 w-[98%]">
        ...
        <div className="flex h-fit">
          <div className="w-[50%]">
            ...
            <div className="text-justify">
              ...
              NeuraCRM allows users to seamlessly interact with their Jira
              ...
              <br />
              <br />
              Before integrating Jira with NeuraCRM, you need a valid Atlassian
        ...
        <p>
          ...
          <br />
          <sup>
            As of v1.0 of NeuraCRM, only the creation of Jira issues is
            supported.
          </sup>
        </p>
        <h3 className="scroll-m-20 text-2xl font-semibold tracking-tight">
